...
#define BUTTON_MARGIN_X 4
#define BUTTON_MARGIN_Y 18
...
@interface SACalendar () <UICollectionViewDataSource, UICollectionViewDelegate>{
    ...
    NSMutableDictionary *previousMonthLabels;
    NSMutableDictionary *nextMonthLabels;
     ...
     pagingEnabled:(BOOL)paging
{
    ...
    if (self) {
        ...
        previousMonthLabels = [NSMutableDictionary dictionary];
        nextMonthLabels = [NSMutableDictionary dictionary];
        ...
        self.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"trialImage.png"]];
...
- (UIViewController *) controllerAtIndex:(NSInteger) index {
     ...
     */
    calendar = [calendars objectForKey:[NSString stringWithFormat:@"%li",(long)index]];
    [calendar reloadData];
    ...
    if (![controllers objectForKey:[NSString stringWithFormat:@"%li",(long)index]]) {
        UIViewController *contr = [[UIViewController alloc] init];
        contr.view.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"trialImage.png"]];
        ...
        calendar = [[UICollectionView alloc]initWithFrame:rect collectionViewLayout:flowLayout];
        ...
        UILabel *previousMonthLabel = [[UILabel alloc]initWithFrame:CGRectMake(35, 0, 50, headerSize)];
        previousMonthLabel.font = [UIFont systemFontOfSize: 15.0f];
        previousMonthLabel.textAlignment = NSTextAlignmentCenter;
        previousMonthLabel.text = [NSString stringWithFormat:@"%@",[DateUtil getMonthString:month-1]];
        previousMonthLabel.textColor = headerTextColor;
        
        [contr.view addSubview:previousMonthLabel];
        
        UILabel *nextMonthLabel = [[UILabel alloc]initWithFrame:CGRectMake(self.bounds.size.width - 85, 0, 50, headerSize)];
        nextMonthLabel.font = [UIFont systemFontOfSize: 15.0f];
        nextMonthLabel.textAlignment = NSTextAlignmentCenter;
        nextMonthLabel.text = [NSString stringWithFormat:@"%@",[DateUtil getMonthString:month+1]];
        nextMonthLabel.textColor = headerTextColor;
        
        [contr.view addSubview:nextMonthLabel];
        ...
        [previousMonthLabels setObject:previousMonthLabel forKey:[NSString stringWithFormat:@"%li",(long)index]];
        [nextMonthLabels setObject:nextMonthLabel forKey:[NSString stringWithFormat:@"%li",(long)index]];
        ...
        [contr.view addSubview:prevButton];
        prevButton.frame = CGRectMake(BUTTON_MARGIN_X, BUTTON_MARGIN_Y, 48, 38);
        ...
        [contr.view addSubview:nextButton];
        nextButton.frame = CGRectMake(self.bounds.size.width - 48 - BUTTON_MARGIN_X, BUTTON_MARGIN_Y, 48, 38);
        
        self.nextButton = nextButton;
        
        // weekdays
        NSArray* weekdays = [NSArray arrayWithObjects:@"Su", @"M", @"T", @"W", @"Th", @"F", @"Sa", nil];
        float day_width = 320/7;
        for (int i=0; i<7; i++)
        {
            UILabel* each_day = [[UILabel alloc] init];
            [each_day setText:[weekdays objectAtIndex:i]];
            [each_day setTextColor:[UIColor whiteColor]];
            [each_day setTextAlignment:NSTextAlignmentCenter];
            CGRect each_day_frame = CGRectMake(i*day_width, contr.view.frame.origin.x + 50, day_width, 44);
            [each_day setFrame:each_day_frame];
            [contr.view addSubview:each_day];
        }
        return contr;
    }
    else{
...
- (NSInteger)collectionView:(UICollectionView *)collectionView numberOfItemsInSection:(NSInteger)section
{
    ...
    UILabel *previousMonthLabel = [previousMonthLabels objectForKey:[NSString stringWithFormat:@"%li",(long)collectionView.tag]];
    previousMonthLabel.text = [NSString stringWithFormat:@"%@",[DateUtil getMonthString:monthToLoad-1]];
    
    UILabel *nextMonthLabel = [nextMonthLabels objectForKey:[NSString stringWithFormat:@"%li",(long)collectionView.tag]];
    nextMonthLabel.text = [NSString stringWithFormat:@"%@",[DateUtil getMonthString:monthToLoad+1]];
